...
- [pending] 2026-04-19: [ENGINEERING][CODEX PRO] Полная активация Codex Pro-контуров (чат, кнопки, мультимодальность, image workflows)
  ...
  - Что сделать:
    ...
    4. Добавить проверку после перезапуска VS Code и VPN-flap (устойчивость состояния)
  - Артефакт:

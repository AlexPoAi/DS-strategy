...
════════════════════════════════════════════════════════════
📋 ОТЧЁТ ЦЕПОЧКИ СТРАТЕГИРОВАНИЯ 24.03.2026 22:39
════════════════════════════════════════════════════════════
...
⑤ MANUAL-REVIEW / НЕРАЗОБРАННОЕ
   ...
   → 2. Черновики/00-Ручной разбор/F4-Предприниматель-Требования/Кухня и ее развитие.md
   → 2. Черновики/00-Ручной разбор/F4-Предприниматель-Требования/Переход на патентную систему.md
   → 2. Черновики/00-Ручной разбор/F4-Предприниматель-Требования/Приоритет.md
   → 2. Черновики/00-Ручной разбор/F4-Предприниматель-Требования/Рекламная вывеска на Самокиша.md

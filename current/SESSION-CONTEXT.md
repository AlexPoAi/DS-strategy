...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:32
...
**Статус:** задача закрыта — ENG.WP.025: локальный агентный слой переведён в режим Codex-primary / Claude-fallback; документация и архитектурный контур обновлены

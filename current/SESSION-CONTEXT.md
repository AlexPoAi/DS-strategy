...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:35
...
**Статус:** задача закрыта — ENG.WP.025: legacy extractor entrypoint переведён на ai-run.sh, claude-run.sh оставлен совместимым wrapper, setup/ECOSYSTEM обновлены под AI-CLI-first

...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:28
...
**Статус:** задача закрыта — ENG.WP.024: добавлен provider fallback Claude→Codex в strategist/extractor; mock smoke tests пройдены

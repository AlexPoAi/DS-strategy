...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:08
...
**Статус:** задача закрыта — ENG.WP.007 slice: добавлен operational rotation registry по secret groups (update points, owner layer, smoke tests, status)

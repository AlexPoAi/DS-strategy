...
## Где мы находимся
**Последнее обновление:** 2026-03-30 15:39
...
**Статус:** задача закрыта — WP-43: Починил RAG индексацию на VPS — добавил прокси OpenAI в .env, создал venv, переиндексировал ChromaDB (287 документов), перезапустил сервисы. Бот работает.

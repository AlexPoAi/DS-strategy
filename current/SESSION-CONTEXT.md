...
## Где мы находимся
**Последнее обновление:** 2026-04-05 22:56
...
**Статус:** задача закрыта — ENG.WP.014: зафиксирована карта OpenAI-first always-on migration и выделены first migration targets

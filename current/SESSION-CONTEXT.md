...
## Где мы находимся
**Последнее обновление:** 2026-03-30 14:25
...
**Статус:** задача закрыта — WP-39: Починка notify.sh после дрейфа путей IWE→Github. Исправлены: strategist.sh:64, protocol-close.md (2 места). Создан ENG.WP.004. Мозг экзокортекса → зелёный.

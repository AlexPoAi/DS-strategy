...
## Где мы находимся
**Последнее обновление:** 2026-04-17 20:02
...
**Статус:** задача закрыта — WP-65: добавлен синк папки склада Жанны (1oo1j86l) в warehouse_full_loop.sh; sync-google-sheets.py принимает GOOGLE_DRIVE_FOLDER_ID из env

...
## Где мы находимся
**Последнее обновление:** 2026-03-27 20:20
...
**Статус:** задача закрыта — Domain-contracts PACK-management v1.3: закрыт — смена, инвентаризация, кассовый отчёт, передача выручки, расхождение (единый объект 2 типа: товарное/кассовое), retail-товар, склад

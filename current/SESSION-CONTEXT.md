...
## Где мы находимся
**Последнее обновление:** 2026-04-05 00:13
...
**Статус:** задача закрыта — FMT-exocortex-template CI fix: заменены личные пути на плейсхолдеры в 25 файлах, validate-template зелёный

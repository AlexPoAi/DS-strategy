...
## Где мы находимся
**Последнее обновление:** 2026-03-28 20:05
...
**Статус:** задача закрыта — PACK-kitchen рефактор: ENTITY.002 (Повар) → deprecated, созданы ROLE.001 (Повар), ROLE.002 (Младший повар), ROLE.003 (Раннер) по FPF A.7 — роль ≠ система

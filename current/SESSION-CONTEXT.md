...
## Где мы находимся
**Последнее обновление:** 2026-04-17 20:29
...
**Статус:** задача закрыта — WP-66 final: Google Drive auth с записью, созданы папки Новое/Обработано, 11 старых файлов перемещены, pipeline читает из Новое и перемещает в Обработано, ручной режим

...
## Где мы находимся
**Последнее обновление:** 2026-03-28 19:13
...
**Статус:** задача закрыта — FPF-моделирование PACK-kitchen: созданы карточки 004 (Ингредиент v1.1), 005 (Кухонный цех v1.1), 006 (Блюдо v1.0) — совместно с FPF Консультантом через веб-режим

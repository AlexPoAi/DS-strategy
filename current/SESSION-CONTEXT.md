...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:16
...
**Статус:** задача закрыта — ENG.WP.023: реализован fallback моделей Haiku→Sonnet в strategist/extractor, Opus запрещён, mock smoke test пройден

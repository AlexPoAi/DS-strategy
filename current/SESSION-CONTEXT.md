...
## Где мы находимся
**Последнее обновление:** 2026-04-07 22:56
...
**Статус:** задача закрыта — ENG.WP.027: runtime arbiter for equal Codex/Claude provider selection implemented; health-check and opening artifacts now reflect truthful provider/runtime mode

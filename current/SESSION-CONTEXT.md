...
## Где мы находимся
**Последнее обновление:** 2026-04-03 21:49
...
**Статус:** задача закрыта — PARK: анализ документов ЛУКС (П240, ДС1-3, АВР1) — карточки DOC.015-020, стратегия переговоров WP.025-026, коммуникации COMM.010-011

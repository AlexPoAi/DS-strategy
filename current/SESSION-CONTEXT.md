...
## Где мы находимся
**Последнее обновление:** 2026-04-27 16:50
...
**Статус:** рабочая продукция по Karpathy-интеграции закрыта локально
**Активный РП:** W18 / дисциплина агентов и экзокортекса
**Следующий шаг:** Работать local-first до снятия GitHub trade-controls block с DS/FMT репозиториев.

...
|---|-----|--------|--------|---------|
| 13 | Ответ архитектору: график с датами + вопросы по АГО и договору | 1.5h | in_progress | 14 мар |
| 4 | Переговоры с архитектором — РНС, этапность, сроки | 1h | in_progress | 15 мар |

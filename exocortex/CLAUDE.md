...
Рабочая директория: `/Users/alexander/IWE/` (не из sub-директорий). `/Users/alexander/IWE/memory/` = симлинк на auto-memory.
...
- `/Users/alexander/IWE/` — рабочая директория

### Read-only репо


### Google Workspace route (авторский L3)

Google Drive / Google Calendar / Gmail задачи идут только через
...
+ `DS-strategy/PACK-exocortex-engineering/04-work-products/ENG.WP.046-google-workspace-operating-contract (Единый operating contract Google Workspace для экзосистемы).md`.

Claude и Codex используют один процессный маршрут; разные tools/MCP/connectors
считаются адаптерами, а не отдельными маршрутами. Если tool-доступа нет при
наличии контракта или permissions, это `route drift`, а не повод молча обходить
контракт.

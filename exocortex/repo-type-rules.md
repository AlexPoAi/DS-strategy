...
## Именование файлов при копировании/перемещении

**Правило:** Не называть файл по папке назначения (например, "04-work-products"). Имя файла должно отражать содержимое — что это за документ.

Примеры:
- ❌ `04-work-products-график.xlsx`
- ✅ `PARK.WP.019-construction-schedule-golubinka.xlsx`
- ✅ `График-формирования-пакета-РНС-Голубинка.xlsx`

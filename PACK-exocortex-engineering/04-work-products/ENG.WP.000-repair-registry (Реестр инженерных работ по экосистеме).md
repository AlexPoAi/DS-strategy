...
| ENG.WP.045 | Реестр инженерных веток предметных областей | 2026-04-23 | ✅ done |
| ENG.WP.046 | Жёсткий gate закрытия инженерной итерации | 2026-04-23 | ✅ done |
| ENG.WP.047 | Автоматическая конвертация заметок в РП (Note-to-WP pipeline) | 2026-05-05 | 🔄 active |

...
## Контрольные напоминания

1. `2026-04-22`: если нет ответа — отправить follow-up в appeal/поддержку с запросом ETA по appeal и refund.
2. `2026-04-24`: контрольная сверка статуса (в письме фигурирует дата удаления Francis org).
